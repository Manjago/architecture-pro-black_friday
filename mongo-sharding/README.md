...
Запускаем скрипт инициализации еще раз. Теперь он пропустит уже настроенные реплики и успешно выполнит команды для `mongos`: добавит шарды и включит шардинг для базы данных `somedb`.
